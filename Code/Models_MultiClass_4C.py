...
def ModelBaseline_OneVsRest(nb_n1=100,nb_n2=50):
    ...
    model = Model(inputs=[inputs], outputs=[out_coh,out_hyper,out_mero,out_random])
...
def ModelOneVsRest_SharedPrivate_2Per2(nb_n1=100,nb_n2=50):
    ...
    ind_random1=concatenate([inputs,x_shared_coh_random])
    ind_random2=concatenate([inputs,x_shared_hyper_random])
    ind_random3=concatenate([inputs,x_shared_mero_random])
    ...
    out_random_pre=concatenate([out_random1,out_random2,out_random3])
...
def ModelOneVsRest_SharedPrivate_3Per3(nb_n1=100,nb_n2=50):
    ...
    ind_coh3=concatenate([inputs,x_shared_coh_mero_random])

    
    
    ind_hyper1=concatenate([inputs,x_shared_coh_hyper_mero])
    ind_hyper2=concatenate([inputs,x_shared_coh_hyper_random])
    ind_hyper3=concatenate([inputs,x_shared_hyper_mero_random])

    
    
    ind_mero1=concatenate([inputs,x_shared_coh_hyper_mero])
    ind_mero2=concatenate([inputs,x_shared_coh_mero_random])
    ind_mero3=concatenate([inputs,x_shared_hyper_mero_random])

    
    
    ind_random1=concatenate([inputs,x_shared_coh_mero_random])
    ind_random2=concatenate([inputs,x_shared_coh_hyper_random])
    ind_random3=concatenate([inputs,x_shared_hyper_mero_random])
...
def ModelOneVsRest_All_shared_2Per2(nb_n1=100,nb_n2=50):
    ...
    ind_hyper3=x_shared_coh_hyper
    
    
    ind_mero1=x_shared_mero_random
    ind_mero2=x_shared_hyper_mero
    ind_mero3=x_shared_coh_mero
    
    
    ind_random1=x_shared_coh_random
    ind_random2=x_shared_hyper_random
    ind_random3=x_shared_mero_random
...
def ModelOneVsRest_AllShared_3Per3(nb_n1=100,nb_n2=50):
    ...
    ind_coh3=x_shared_coh_mero_random
 
    
    
    ind_hyper1=x_shared_coh_hyper_mero
    ind_hyper2=x_shared_coh_hyper_random
    ind_hyper3=x_shared_hyper_mero_random

    
    
    ind_mero1=x_shared_coh_hyper_mero
    ind_mero2=x_shared_coh_mero_random
    ind_mero3=x_shared_hyper_mero_random

    
    
    ind_random1=x_shared_coh_hyper_random
    ind_random2=x_shared_coh_mero_random
    ind_random3=x_shared_hyper_mero_random
