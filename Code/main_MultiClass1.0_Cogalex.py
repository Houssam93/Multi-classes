...
name_str=['hier_coga','hier_connected_coga']
print(name_str)
...
#is_MultiClass=[False,True,True,True,True,True,True,True]
#is_MultiClass=[True,True,True,True,True,True,True]

name_models=[hier_coga,hier_connected_coga]
is_MultiClass=[True,True]
...
def main(inp):
    ...
    for nnn in range(len(name_models)) :
    	print(name_str[nnn])
    	df_means_max,df_means_overall=multi_main_vote(name_models[nnn],name_str[nnn],nb_1,nb_2,nb_occ)
   ...
   # df_restit=(multi_main_vote(name_model,nb_1,nb_2,nb_occ))  
    #return df_restit
    df_restit_max.to_csv('../Results/Hier_Cogalex_Classes_n1'+str(nb_1)+'_n2_'+str(nb_2)+'.csv')
    df_restit_overall.to_csv('../Results/Hier_Cogalex_Overall_n1'+str(nb_1)+'_n2_'+str(nb_2)+'.csv')
