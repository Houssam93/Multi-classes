...
'ModelOneVsRest_All_shared_2Per2','ModelOneVsRest_SharedPrivate_2Per2','ModelOneVsRest_SharedPrivate_3Per3',
'ModelOneVsRest_SharedPrivate_4Per4','ModelOneVsRest_AllShared_3Per3','ModelOneVsRest_AllShared_4Per4','hier']
print(name_str)
